...
- **Your agents need the data.** MCP access with a documented tool surface (45 tools in World Monitor's case) lets Claude or GPT query live intelligence under one key.
...
| Pro | $39.99/month or $399.99/year | Analysts: WM Analyst chat with citations, Scenario Engine, Route Explorer, AI digest, MCP access with 45 tools |
