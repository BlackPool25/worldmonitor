...
The public dashboard exposes 57 map-layer types, 500+ curated news feeds backed by 550+ observed upstream hosts, country briefs, instability scores, chokepoints, infrastructure, markets, disasters, and watchlists. Every layer except the Resilience layer is available on the free plan, and the dashboard can be opened without an account.
