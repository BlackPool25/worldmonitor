...
describe('OpenAPI jmespath projection parameter contract', () => {
  ...
  it('per-service JSON specs advertise jmespath on every GET (189 total)', () => {
    ...
    assert.equal(total, 189, `expected 189 GET operations, found ${total}`);
  });

  it('per-service YAML specs advertise jmespath on every GET (189 total)', () => {
  ...
  it('the unified bundle advertises jmespath on every GET (189 total)', () => {
