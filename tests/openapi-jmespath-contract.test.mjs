...
describe('OpenAPI jmespath projection parameter contract', () => {
  ...
  it('per-service JSON specs advertise jmespath on every GET (190 total)', () => {
    ...
    assert.equal(total, 190, `expected 190 GET operations, found ${total}`);
  });

  it('per-service YAML specs advertise jmespath on every GET (190 total)', () => {
  ...
  it('the unified bundle advertises jmespath on every GET (190 total)', () => {
