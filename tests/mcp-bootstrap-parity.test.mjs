...
const EXCLUDED_FROM_MCP = new Map([
  ...
  ['seed-meta:trade:flows',
    'operational: meta-only aggregate health probe added by #6309 for sharded trade:flows:v2:{reporter}:{partner} payloads; no queryable data slice lives at this key. The rows themselves are served by GET /api/trade/v1/get-trade-flows and are not MCP-exposed (get_supply_chain_data carries comtrade:flows:v1, which is UN Comtrade, not WTO).'],
