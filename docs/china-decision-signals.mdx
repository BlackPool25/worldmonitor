...
automated caller cannot report a staging audit it never performed. The live
probe validates both the composition RPC and the public `chinaDecisionSignals`
