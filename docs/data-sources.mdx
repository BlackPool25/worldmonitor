...
SGE ingestion is fail-closed behind `SGE_MARKET_DATA_LICENSED=true`. Operators
must set the flag only after redistribution, display, and attribution rights
are documented for the deployment. See the SGE
[market-data license page](https://en.sge.com.cn/data_Licensed).
