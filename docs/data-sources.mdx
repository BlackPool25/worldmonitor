...
| [Environment & Disasters](#environment-%26-disasters) | Earthquakes, disasters, wildfires, cyclones, climate anomalies | USGS, NRCan, GDACS, NASA FIRMS/EONET, Open-Meteo |
...
- Earthquakes from USGS (global M4.5+ week) merged with Earthquakes Canada (NRCan) national Atom, filtered to the same M4.5 / 7-day window and excluding industry-related events
...
| Earthquakes Canada (NRCan) | Canadian national seismic bulletin (Atom) | [earthquakescanada.nrcan.gc.ca](https://www.earthquakescanada.nrcan.gc.ca/index-en.php?tpl_region=canada) |
