...
- NASA FIRMS satellite fire detection (VIIRS thermal hotspots) merged with CWFIS national agency-reported active fires; prescribed burns are labelled and never paged as emergencies
