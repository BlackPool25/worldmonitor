...
- USDA FAS PSD food stocks and stocks-to-use by commodity and marketing year, with FAOSTAT production used only to fill countries PSD does not cover. Freshness is keyed on whether the latest marketing year is present, not on fetch time. USDA PSD is public domain; FAOSTAT is CC-BY and requires attribution to FAO.
...
| USDA FAS PSD | Commodity production, consumption, trade, and ending stocks by marketing year | [apps.fas.usda.gov/psdonline](https://apps.fas.usda.gov/psdonline/) |
| FAOSTAT | Crop production quantities for countries outside PSD coverage (CC-BY) | [faostat.fao.org](https://www.fao.org/faostat/) |
