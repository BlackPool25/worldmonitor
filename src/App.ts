  ...
  private setupRefreshIntervals(): void {
    ...
    if (SITE_VARIANT !== 'happy') {
      this.refreshScheduler.registerAll([
        ...
        { name: 'pipelineRegistries', fn: () => this.dataLoader.loadPipelineRegistries(), intervalMs: REFRESH_INTERVALS.pipelineStatus, condition: () => !!this.state.mapLayers.pipelines },
        { name: 'storageFacilities', fn: () => this.dataLoader.loadStorageFacilities(), intervalMs: REFRESH_INTERVALS.storageFacilityMap, condition: () => !!this.state.mapLayers.storageFacilities },
