...
export const LAYER_REGISTRY: Record<keyof MapLayers, LayerDefinition> = {
  ...
  canadaRoads:              def('canadaRoads',              '&#128679;', 'canadaRoads',              'Ontario and Alberta Roads (511)', ['flat'], undefined, true),
...
export const LAYER_EXPLANATIONS: Partial<Record<keyof MapLayers, LayerExplanation>> = {
  ...
  canadaRoads: {
    ...
    coverage: 'curated',
    category: 'Transport',
    purpose: 'Shows highway incidents and provincial alerts in Ontario and Alberta, plus Ontario road conditions, from the official 511 feeds.',
