...
export const LAYER_EXPLANATIONS: Partial<Record<keyof MapLayers, LayerExplanation>> = {
  ...
  canadaRoads: {
    ...
    coverage: 'curated',
    category: 'Transport',
    purpose: 'Shows highway incidents, provincial alerts, and road conditions in Ontario from the official 511 feed.',
    source: 'Ontario 511 (511on.ca) events, alerts, and road-conditions APIs, seeded through WorldMonitor.',
    freshness: 'Ontario 511 is seeded every 15 minutes and monitored against a 45-minute freshness budget.',
    confidence: 'Authoritative for Ontario Ministry of Transportation 511 reports, subject to upstream publication timing and mapped geometry.',
    limitations: [
      'Currently Ontario only; Alberta and Manitoba 511 must use this same canadaRoads layer key when they ship.',
    ...
    evidence: ['scripts/seed-provincial-511.mjs', 'api/health.js', 'src/services/canada-roads.ts'],
  },
  flights: {
    key: 'flights',
    coverage: 'curated',
