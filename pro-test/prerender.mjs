...
// `hidden <bp>:<display>` reveal (e.g. `hidden lg:flex` nav rows, `hidden
...
// `nav [class~="lg:flex"]`/`main [class~="sm:block"]` reveals below).
const CRITICAL_CSS = [
  ...
  '@media (min-width:1024px){nav [class~="lg:flex"]{display:flex}}',
].join('');
