...
| `railway-deploy.yml` | Push to main | Selects changed filtered Railway service closures in CI and triggers latest-source deploys explicitly, bypassing Watch Paths as a correctness boundary |
